...
#     #Painkiller_usage
#     Painkiller_usage = 0 if Painkiller_usage == 'No' else Painkiller_usage
#     Painkiller_usage = 1 if Painkiller_usage == 'Yes' else Painkiller_usage
#     #Pain_duration
#     Pain_duration = 0 if Pain_duration == 'more than 2 days' else Pain_duration
#     Pain_duration = 1 if Pain_duration == 'less than 2 days' else Pain_duration
#     Pain_duration = 99 if Pain_duration == 'NA' else Pain_duration
#     #affected_tooth
#     affected_tooth = 0 if affected_tooth == 'No' else affected_tooth
#     affected_tooth = 1 if affected_tooth == 'Yes' else affected_tooth
#     affected_tooth = 99 if affected_tooth == 'NA' else affected_tooth
#     #tooth_open_history
#     tooth_open_history = 0 if tooth_open_history == 'No' else tooth_open_history
#     tooth_open_history = 1 if tooth_open_history == 'Yes' else tooth_open_history
#     tooth_open_history = 99 if tooth_open_history == 'NA' else tooth_open_history
#     #Pulp_Vitality
#     Pulp_Vitality = 0 if Pulp_Vitality == '-ve' else Pulp_Vitality
#     Pulp_Vitality = 1 if Pulp_Vitality == '+ve' else Pulp_Vitality
#     Pulp_Vitality = 99 if Pulp_Vitality == 'NA' else Pulp_Vitality


#     # painkiller_usage = 1 if painkiller_usage == 'Yes' else 0
#     # pain_duration = 1 if pain_duration == 'Less than 2 days' else 0 if pain_duration == 'More than 2 days' else 99
#     # affected_tooth = 1 if affected_tooth == 'Yes' else 0 if affected_tooth == 'No' else 99
#     # tooth_open_history = 1 if tooth_open_history == 'Yes' else 0 if tooth_open_history == 'No' else 99
#     # pulp_vitality = 1 if pulp_vitality == '+ve' else 0 if pulp_vitality == '-ve' else 99
    
#     # st.write('gggg')
#     # st.write(painkiller_usage)
#     # st.write('www')
#     # st.write(pain_duration)
#     # st.write('sss')
#     # st.write(affected_tooth)
#     # st.write('aaa')
#     # st.write(tooth_open_history)
#     # st.write('xxx')
#     # st.write(pulp_vitality)
